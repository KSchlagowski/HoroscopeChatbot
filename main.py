...
if __name__ == '__main__':
    try:
        ...
        while True:
            ...
            if message == "/exit":
                break
            response = bot.rag_chain.invoke(message)
            print(response)
    except Exception as e:
        logging.error(f"Critical error during chatbot initialization: {str(e)}")

#prompt1 = "How will Taurus's professional life evolve throughout the year?"
# prompt2 = "How can Scorpio deepen their personal connections?"
# prompt3 = "What activities will benefit Sagittarius's overall well-being?"
# prompt4 = "What activities will benefit Aries's overall well-being?"
# prompt5 = "How can Pisces maintain balance in their health and wellness?"
# prompt6 = "How do the financial forecasts for Taurus and Capricorn align or differ?"